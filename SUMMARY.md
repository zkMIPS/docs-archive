...
* [☀️ Getting Started](<README (1).md>)
  ...
  * [Background Behind zkVMs](getting-started/background-behind-zkvms/README.md)
    * [zkMIPS: a High-Level Specification](getting-started/background-behind-zkvms/zkmips-a-high-level-specification.md)
